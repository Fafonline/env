...
function! s:Project(filename) " <<<
    ...
    function! s:CreateEntriesFromDir(recursive)
	    ...
	    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
	    "
	    "DEPRECATED CODE:Browse do not support  directory selection on rh5 linux distribution 	    
            "let dir = browse(0, 'Enter the '.absolute.'Directory to Load: ', '', '')
	    "
            "NEW CODE: Use browsedir.
    ...
    if !exists("g:proj_running")
        ...
        nnoremap <buffer> <silent> <LocalLeader>O  \|:call <SID>DoFoldOrOpenEntry('', '!cleartool co')<CR>
        nnoremap <buffer> <silent> <LocalLeader>N  \|:call <SID>DoFoldOrOpenEntry('', '!cleartool ci')<CR>
        nnoremap <buffer> <silent> <LocalLeader>U  \|:call <SID>DoFoldOrOpenEntry('', '!cleartool unco')<CR>
